  ...
  angular
    ...
    .controller("ToggleController", [
      ...
      function(
        ...
        this.init = function(ngModelCtrl_) {
          ...
          angular
            .element(self.onElement)
            .addClass(self.onClass)
            .addClass("toggle-on");
          angular
            .element(self.offElement)
            .addClass(self.offClass)
            .addClass("toggle-off");
        ...
        this.computeStyle = function() {
          ...
          $scope.wrapperStyle = self.toggleStyle
        ...
        $scope.onSwitch = function(evt) {
          if (self.disabled) {
            // prevent changing .$viewValue if .disabled == true
            return false;
          } else {
    ...
    .directive("toggle", function() {
      return {
        restrict: "E",
        template:
          '<div ng-cloak class="toggle btn off" ng-style="wrapperStyle"' +
